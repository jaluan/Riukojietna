function out = P_mu_totalLSD_jla(z,h,Rc,SPhi,consts,dflag)

% NOTE: _jla: This version of the code is modified to only output one scaling
% scheme dependent on input (line 217-253), Jane Lund Andersen 21/11/2023.
...
% Attenuation lengths
for a = 1:length(h)
    LambdaMu(a,:) =(Href-h(a))./(log(phi_site)-log(phiRef));
end
...
% jla: changed to not specify scaling scheme here, this is controlled by 
% input in 'consts'
